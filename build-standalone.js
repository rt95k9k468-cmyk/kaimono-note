...
/* ここには @font-face の woff2 を data URI に差し替える処理がありました。
   書体を端末のものに揃えたので、埋め込むファイルが無くなりました
   （css/base.css の「書体」の節に経緯）。この一枚だけのビルドは
   「どこに置いても、そのまま開ける」約束なので、外に置いたファイルへの
   参照が css に入ったら、また同じ仕掛けが要ります。 */
