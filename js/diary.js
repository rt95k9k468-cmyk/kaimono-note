/* =========================================================
   ...
   **いまは、まだどこからも使われていません**（2026年9月26日に確かめた）。
   日記の本文は、ほかの記録と同じ localStorage の一本の中
   （`state.archive.days[].memo`）にあります。下の説明は、ここへ移すときの
   設計です。移すかどうかは docs/improvements.md の A1 を読むこと——移すなら、
   書き出し・自動の控え・復元の三つ全部に、この置き場を足すこと。
