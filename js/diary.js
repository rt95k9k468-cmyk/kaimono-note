/* =========================================================
   ...
   **このファイルは、どこからも使われていません**（2026年9月26日）。
   日記の本文は、いまは localStorage の一本（`state.archive.days[].memo`）と、
   大きな保存場所の写し（js/diary-idb.js。**暗号にはしない**と利用者が
   決めた）の二か所にあります。docs/improvements.md の A1(b)・docs/storage.md。
   下の説明は、暗号にして置くときの設計（D7）として残してあります——使う
   なら、書き出し・自動の控え・復元の三つ全部に、この置き場を足すこと。
