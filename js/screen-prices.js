    ...
    const chrome = node(html`
      <div class="stack">
        ...
        ${/* **ここに紙はありません。**
              ...
              価格は買うものの**後ろに敷いてある地**です。前は買うものと
              同じ `.tl-sheet` と掴み手を組んでいて、めくっている最中に
              丸角の白い紙と掴み手が二組そろって出ていました（実測：
              背面の紙も掴み手も top 42、前面のものと同時に見えていた）。

              二枚のページを重ねて片方をずらしていたので、そう見えたのでは
              なく**本当に二枚あった**、ということです。後ろにいるものは
              紙に乗りません——札も一覧も、地の上に普通に並ぶだけ。丸角も
              掴み手も、前に居る一枚（買うもの）だけが持ちます。 */""}
        <div class="prices-ground js-body"></div>
      </div>
    `);
